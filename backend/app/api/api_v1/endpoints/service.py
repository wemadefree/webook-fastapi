...
requisition_router = req = APIRouter()
...
@req.post("/servicerequisitons", response_model=LooseServiceRequisitionReadExtra)
...
@req.get("/servicerequisitons", response_model=List[LooseServiceRequisitionRead])
def list_servicerequisitons(*, session: Session = Depends(get_session), offset: int = 0, limit: int = Query(default=100, lte=100)):
    servicerequisitons = CrudManager(LooseServiceRequisition).read_items(session, offset, limit)
    return servicerequisitons


@req.get("/servicerequisiton/{servicerequisiton_id}", response_model=LooseServiceRequisitionReadExtra)
...
@req.patch("/servicerequisiton/{servicerequisiton_id}", response_model=LooseServiceRequisitionReadExtra)
...
@req.delete("/servicerequisiton/{servicerequisiton_id}")
